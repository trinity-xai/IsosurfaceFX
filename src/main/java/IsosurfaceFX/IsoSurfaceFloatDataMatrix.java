 ...
 *  byte array as storage for the data set.
**/
public class IsoSurfaceFloatDataMatrix extends IsoSurfaceDataMatrix {
  ...
  **/
  private final float leastValue;
  ...
  **/
  public IsoSurfaceFloatDataMatrix(final byte _plane,
                                   ...
                                   final float _leastValue)
  {
    ...
    switch(plane) {
      case XZ_PLANE : matrix = new float[_yMaxDim][][];
                      break;
      case XY_PLANE : matrix = new float[_zMaxDim][][];
                      break;
      default :       matrix = new float[_xMaxDim][][];
    } // end switch
    matRef = matrix;
  ...
  **/
   ...
   *  data corresponds to.
   * @param _dataPlane A two dimensional float array that contains a plane's
   *  worth of 3-D data to be inserted at the index specified.
  **/
  public void setPlaneData(final int _idx, final float[][] _dataPlane) {
...
} // end class IsoSurfaceFloatDataMatrix
